...
// Registramos los plugins requeridos por este componente
gsap.registerPlugin(ScrollTrigger, GSAPSplitText, useGSAP);

// Definición de las props del componente SplitText
...
const SplitText: React.FC<SplitTextProps> = ({
  ...
  // Asegura que las fuentes se carguen antes de dividir el texto (Best Practice UX/GSAP)
  useEffect(() => {
  ...
  useGSAP(
    () => {
      ...
      // Limpia instancias previas (importante para Fast Refresh de Next.js)
      ...
      // Cálculo de ScrollTrigger: Define cuándo comienza la animación basada en el threshold/rootMargin
  ...
  const renderTag = () => {
    // Estilos internos para asegurar que el texto dividido se comporte correctamente
    ...
    // Renderiza el elemento con el tag HTML especificado
    switch (tag) {
